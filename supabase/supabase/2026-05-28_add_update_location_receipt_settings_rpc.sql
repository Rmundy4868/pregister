-- Adds RPC helper to persist location receipt/tip settings in RLS fallback flows.
...
begin
  ...
  if has_print_tip_suggestions and has_tip_suggestion_1_pct and has_tip_suggestion_2_pct and has_tip_suggestion_3_pct and has_tip_suggestion_base and has_receipt_card_signature_message and has_receipt_misc_message then
...
revoke all on function public.update_location_receipt_settings_from_app(text, uuid, text, boolean, numeric, numeric, numeric, text, text, text) from public;
grant execute on function public.update_location_receipt_settings_from_app(text, uuid, text, boolean, numeric, numeric, numeric, text, text, text) to anon, authenticated;
