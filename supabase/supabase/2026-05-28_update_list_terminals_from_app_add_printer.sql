-- Extends list_terminals_from_app to return receipt_printer_name and
-- card reader fields so UI can populate terminal editor without relying on
-- direct table reads that may be blocked by RLS.
