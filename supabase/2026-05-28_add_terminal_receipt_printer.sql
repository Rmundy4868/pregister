-- Adds receipt_printer_name to terminals so each terminal can specify its default receipt printer.
...
-- Update upsert RPC to accept receipt_printer_name
drop function if exists public.upsert_terminal_from_app(text, uuid, uuid, text, text, text, text, text, boolean);
...
revoke all on function public.upsert_terminal_from_app(text, uuid, uuid, text, text, text, text, text, boolean, text) from public;
grant execute on function public.upsert_terminal_from_app(text, uuid, uuid, text, text, text, text, text, boolean, text) to anon, authenticated;
