-- Adds SPIn credentials to terminal upsert RPC so app-side terminal editor can persist them.
...
-- Replace latest receipt-printer signature with SPIn-enabled signature.
drop function if exists public.upsert_terminal_from_app(text, uuid, uuid, text, text, text, text, text, boolean, text);
...
revoke all on function public.upsert_terminal_from_app(text, uuid, uuid, text, text, text, text, text, text, text, boolean, text) from public;
grant execute on function public.upsert_terminal_from_app(text, uuid, uuid, text, text, text, text, text, text, text, boolean, text) to anon, authenticated;
