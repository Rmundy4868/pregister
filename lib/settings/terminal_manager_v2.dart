...
class TerminalManagerV2Dialog extends StatefulWidget {
  const TerminalManagerV2Dialog({super.key});

  @override
  State<TerminalManagerV2Dialog> createState() =>
      _TerminalManagerV2DialogState();
}

class _TerminalManagerV2DialogState extends State<TerminalManagerV2Dialog> {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          trailing: terminalToken.trim().isEmpty
              ? null
              : TextButton(
